...
const initialTutors = [
  { id: 1, name: 'Mohammed Sulthan Akthar', role: 'Platform Admin & Lead Founder', department: 'MCA - Sacred Heart College', subjects: 'Fullstack, React, PHP, Web APIs', available_time: 'Mon-Fri, 10:00 AM - 6:00 PM IST', mode: 'Both', contact: 'sulthan@college.edu', bio: 'Platform Administrator & Lead Full-Stack Mentor. Specializing in cloud architecture, database systems, and modern web applications.', country: 'India', languages: 'English, Tamil', rating: 5.0, sessions_completed: 120, avatar: '/admin-sulthan.jpg' },
  { id: 2, name: 'Ananya Rao', department: 'MCA - Sacred Heart College', subjects: 'DBMS, SQL', available_time: 'Mon-Fri, 4:00-6:00 PM IST', mode: 'Both', contact: 'ananya@college.edu', bio: 'Database mentor focused on normalization and query practice.', country: 'India', languages: 'English, Tamil, Hindi', rating: 4.9, sessions_completed: 38 },
  { id: 3, name: 'Mei Lin', department: 'Computer Science - NUS', subjects: 'Python, Data Science', available_time: 'Tomorrow, 7:00 PM SGT', mode: 'Online', contact: 'mei@university.edu', bio: 'Practical support for pandas, statistics and machine learning.', country: 'Singapore', languages: 'English, Mandarin', rating: 4.8, sessions_completed: 52 },
  { id: 4, name: 'Haruto Sato', department: 'Engineering - University of Tokyo', subjects: 'Java, Algorithms', available_time: 'Saturday, 10:00 AM JST', mode: 'Online', contact: 'haruto@university.edu', bio: 'Java problem solving and algorithm walkthroughs.', country: 'Japan', languages: 'English, Japanese', rating: 4.9, sessions_completed: 44 }
];
