CREATE DATABASE IF NOT EXISTS local_tutor_connector
  CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE local_tutor_connector;
...
INSERT INTO help_requests (student_name, subject, topic, description, preferred_time, mode, contact) VALUES
('Kavin M', 'DBMS', 'Normalization', 'Need help understanding 2NF, 3NF and practice questions.', 'Wednesday after 4 PM', 'Offline', 'kavin@college.edu'),
('Meena P', 'Java', 'Exception handling', 'Looking for a one-hour session with simple coding examples.', 'Friday 5 PM', 'Online', 'meena@college.edu');
